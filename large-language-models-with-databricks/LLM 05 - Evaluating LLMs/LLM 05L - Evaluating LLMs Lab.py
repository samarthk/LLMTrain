...
# MAGIC
# MAGIC **📌 Note:** If you get an error due to dataset's and *splits sizes verification*, you can turn off the **`verification_mode`** by uncommenting the `verification_mode` line.
